...
const raw = [
  ...
  {p:"25", n:"SOLEDAD DE LAS NIEVES SALAZAR SALAZAR",    rifa:20000, pagos:[0,15000,15000,15000,15000,20000,15000,15000,0,0,0,0,0]},
  ...
  {p:"33", n:"CARLOS",                                   rifa:0,     pagos:[0,0,3000,3000,3000,3000,0,0,0,0,0,0,0]},
  ...
  {p:"42", n:"VANESSA HERMINIA INOSTROSA LARA",          rifa:0,     pagos:[0,0,3000,3000,3000,3000,0,0,0,0,0,0,0]},
  ...
  {p:"88", n:"DANIEL ERNESTO ZUÑIGA MORA",               rifa:0,     pagos:[0,0,3000,3000,4000,0,0,0,0,0,0,0,0]},
  ...
  {p:"92", n:"MYRIAM SOLEDAD GUTIERREZ CAMPO",           rifa:0,     pagos:[0,0,3000,3000,3000,3000,3000,3000,3000,3000,0,0,0]},
  ...
  {p:"105",n:"OMAR ANTONIO CARRASCO FUENTES",            rifa:0,     pagos:[0,0,10000,10000,10000,10000,0,0,0,0,0,0,0]},
  {p:"106",n:"OMAR ANTONIO CARRASCO FUENTES",            rifa:0,     pagos:[0,0,10000,10000,10000,10000,0,0,0,0,0,0,0]},
        ...
        {vista==="residente"&&(
          <div style={{display:"flex",flexDirection:"column",gap:14}}>
            ...
            <div style={card}>
              ...
              <div style={{display:"flex",gap:8}}>
                <input
                  ...
                  style={{flex:1,padding:"12px 14px",borderRadius:10,border:`1px solid ${C.border}`,
                    background:"#0f172a",color:C.text,fontSize:16,outline:"none",
              ...
              {error&&<div style={{marginTop:10,color:"#fca5a5",fontSize:13,display:"flex",alignItems:"center",gap:6}}>⚠️ {error}</div>}
            </div>
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                      <div>
                        ...
                        <div style={{fontSize:12,color:"#f59e0b",fontWeight:600,marginTop:6}}>
                          💵 Total pagado: ${r.pagos.reduce((s,v)=>s+v,0).toLocaleString("es-CL")}
                        </div>
                      </div>
